json.extract! @daily_workout_tracker, :id, :dwt_check_in, :dwt_daily_challenge, :percentage_complete, :completed, :dwt_day_number, :program_tracker_id, :daily_workout_id
