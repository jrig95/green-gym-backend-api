...
json.daily_workout_trackers @program_tracker.daily_workout_trackers, :id, :program_tracker_id, :daily_workout_id, :dwt_check_in, :dwt_daily_challenge, :exercise_trackers
