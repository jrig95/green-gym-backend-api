...
json.daily_workout_trackers @program_tracker.daily_workout_trackers, :id, :daily_workout_id, :dwt_check_in, :dwt_daily_challenge, :completed, :dwt_day_number, :exercise_trackers
